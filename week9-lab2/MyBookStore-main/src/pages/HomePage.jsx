...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-viridian-600 to-green-700 text-white bg-black">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/books" 
                ...
                transform hover:scale-105 transition-all duration-200 border-2 border-white">
                เลือกซื้อหนังสือ
